...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="{{ asset('assets/img/logofishku.png') }}" rel="icon">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="sec-heading text-center">
                        <h2>Documentation</h2>
                        <p>Moment kegiatan bersama Fi$hku</p>
                    </div>
                    <div id="testimonials" class="testi owl-carousel wow fadeInUp" data-wow-delay="1.2s">
                        <div class="item">
                            <div class="testimonial-item">
                                <div class="img-fluid">
                                    <img class="mx-auto d-block" src="assets/img/documentation/team.jpg" alt="">
                                </div>
                                <div class="info">
                                    <h2>Workshop di Kali Baru, Jakarta</h2>
                                </div>
                                <!-- <div class="content">
                        ...
                        <div class="item">
                            <div class="testimonial-item">
                                <div class="img-fluid">
                                    <img class="mx-auto d-block" src="assets/img/documentation/workshop1.jpg" alt="">
                                </div>
                                <div class="info">
                                    <h2>Workshop di Kali Baru, Jakarta</h2>
                                </div>
                        ...
                        <div class="item">
                            <div class="testimonial-item">
                                <div class="img-fluid">
                                    <img class="mx-auto d-block" src="assets/img/documentation/workshop2.jpg" alt="">
                                </div>
                                <div class="info">
                                    <h2>Workshop di Kali Baru, Jakarta</h2>
                                </div>
                        ...
                        <div class="item">
                            <div class="testimonial-item">
                                <div class="img-fluid">
                                    <img class="mx-auto d-block" src="assets/img/documentation/workshop4.jpg" alt="">
                                </div>
                                <div class="info">
                                    <h2>Workshop di Kali Baru, Jakarta</h2>
                                </div>
                        ...
                        <div class="item">
                            <div class="testimonial-item">
                                <div class="img-fluid">
                                    <img class="mx-auto d-block" src="assets/img/documentation/workshop5.jpg" alt="">
                                </div>
                                <div class="info">
                                    <h2>Workshop di Kali Baru, Jakarta</h2>
                                </div>
                        ...
                        <div class="item">
                            <div class="testimonial-item">
                                <div class="img-fluid">
                                    <img class="mx-auto d-block" src="assets/img/documentation/workshop6.jpg" alt="">
                                </div>
                                <div class="info">
                                    <h2>Workshop di Kali Baru, Jakarta</h2>
                                </div>
                        ...
                        <div class="item">
                            <div class="testimonial-item">
                                <div class="img-fluid">
                                    <img class="mx-auto d-block" src="assets/img/documentation/workshop7.jpg" alt="">
                                </div>
                                <div class="info">
                                    <h2>Workshop di Kali Baru, Jakarta</h2>
                                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                        <div class="widget">
                            <h3 class="footer-logo"><img src="assets/img/logofishku.png" width="70px" alt=""></h3>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="copyright-content">
                            <p>Copyright © 2022 <a rel="nofollow" href="https://fishku.id">Fi$hku</a> All Right Reserved
                            </p>
                        </div>
                    </div>
                </div>
